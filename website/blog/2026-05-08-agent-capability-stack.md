---
title: "从模型调用到智能执行：AI Agent 工程师需要掌握的 10 层能力"
description: "系统梳理 LLM、Prompt、Context、Tool、Skill、Harness、MCP、Workbench 与 Governance。"
slug: agent-capability-stack
authors:
  - semovix
tags:
  - AI Agent
...
# 从模型调用到智能执行：AI Agent 工程师需要掌握的 10 层能力
